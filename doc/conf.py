# -*- coding: utf-8 -*-
"""
Rackspace Federation build configuration file.
...
htmlhelp_basename = 'docs-rackspace-federation'
...
latex_documents = [
  (master_doc, 'docs-rackspace-federation.tex',
   'Rackspace Federation API Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'Rackspace Federation API documentation',
...
texinfo_documents = [
  (master_doc, 'docs-rackspace-federation',
   'Rackspace Federation API Documentation',
   'Rackspace', 'docs-rackspace-federation',
   'Learn about using the Rackspace Federation documentation',
   'Miscellaneous'),
]
